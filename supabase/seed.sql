...
INSERT INTO item_types (id, org_id, name, icon, color, sort_order) VALUES
  ('00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000100', 'Bird Box', '{"set":"emoji","name":"🏠"}'::jsonb, '#5D7F3A', 0),
  ('00000000-0000-0000-0000-000000000402', '00000000-0000-0000-0000-000000000100', 'Trail Marker', '{"set":"emoji","name":"📍"}'::jsonb, '#8B6914', 1);
